...
class PropbankStructureProber(pl.LightningModule):
    ...
    def _shared_step(self, batch, compute_metrics=False):
        ...
        sense_classification_loss = PropbankStructureProber._compute_classification_loss(
            scores['senses'],
            labels['senses'],
            self.num_senses,
            ignore_index=self.padding_label_id,
        )
        roleset_classification_loss = PropbankStructureProber._compute_binary_classification_loss(
            scores['rolesets'],
            labels['rolesets'],
        )
    ...
    def _shared_epoch_end(self, outputs, stage):
        ...
        metrics = PropbankStructureProber._compute_epoch_metrics(outputs)
